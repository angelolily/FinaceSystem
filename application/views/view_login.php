...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="background-color:rgb(27,109,193);display: none;">
    ...
    <div class="layadmin-user-login-main">
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item">
                <button class="layui-btn layui-btn-warm layui-btn-fluid" lay-submit lay-filter="LAY-user-login-submit" style="background-color:rgb(255,142,1) ">登 入</button>
            </div>
        </div>
    </div>

    <div class="layui-trans layadmin-user-login-footer">
        <p style="color: white">© 2020 所有权归属:福建航天云平台信息服务有限公司<a href="" target="_blank"></a></p>
    </div>
...
<script>
    ...
    form.on('submit(LAY-user-login-submit)', function(obj){
        ...
        if(yz==1){
            $.ajax({
                url:'./index.php/Control_Login/userlogin',
                ...
                success:function (res) {
                    if(res.code==0){
                        layer.msg(res.msg, {
                            ...
                            location.href = './index.php/Control_Main'; //跳转到主页
                        });
                    }
                    else{
    ...
    function repPwd() {
        layer.msg('如果需要修改，请联系管理员', {
            ...
            location.href = '/FinaceSystem/index.php/Control_Login'; //跳转到登入页
        });
